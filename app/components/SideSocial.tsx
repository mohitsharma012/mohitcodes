      ...
      <div className="fixed flex bottom-0 z-20 w-full md:w-auto bg-black md:bg-transparent ">
        <div className="md:flex-col flex  gap-5 text-xl mx-auto md:mx-12 align-center my-5 ">
          <Link
            ...
            target="_blank"
            className="transition ease-in-out hover:-translate-y-hover:-translate-z-4 hover:scale-125 "
          >
            <svg
          ...
          <Link
            href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=DmwnWrRqjCFMCWThRrxdBsJvFFlgbDglQqrLhmCsmtqBRZFCqFDwlkLBxdbSBBrRvZbsLXmTJbgl"
            target="_blank"
            className="transition ease-in-out hover:-translate-y-hover:-translate-z-4 hover:scale-125 "
          >
            <svg
