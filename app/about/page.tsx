...
const ProjectPage = () => {
  ...
  return (
    <>
      <section className=" bg-[url('/Images/pageHeaderBackground.jpg')] bg-cover w-[calc(300% + 1.3px)] min-h-[60vh] bg-bottom bg-no-repeat flex">
        <h1 className="m-auto text-6xl font-bold tracking-tight">ABOUT US</h1>
      </section>
      ...
      <section className="py-32 md:py-52 w-full">
        <div className="flex mx-5 flex-col max-w-7xl md:mx-auto md:flex-row gap-16">
          <img
            ...
            alt=""
          />
          {/* <img src={ project ? project.imageUrl : "/images/404.jpg"} alt="" />
          { project ? project.imageUrl : "/images/404.jpg"} */}
          <div>
